...
namespace ERPStore.Models
{
	...
	/// </summary>
	[Serializable]
	public class Order : ERPStore.Models.ISaleDocument
	{
		public Order()
		{
			ShippingFee = new Fee()
		...
		/// </summary>
		/// <value>The delivery list.</value>
		public LazyList<Delivery> DeliveryList { get; set; }
