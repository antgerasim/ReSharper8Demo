<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<Quote>" %>
...
<div class="ssccompte-list corner">
    <div class="form_elements" id="commentlist">
		 ...
		 <% foreach (Comment comment in Model.Comments) { %>
                ...
                <div id="commentform">
                    <%Ajax.BeginAddCommentToQuoteForm(new AjaxOptions() { HttpMethod = "POST", OnComplete = "processResult" });%>
                    <p><label>Ajouter un commentaire :</label>
                    <%=Html.Hidden("quoteCode", Model.Code)%>
