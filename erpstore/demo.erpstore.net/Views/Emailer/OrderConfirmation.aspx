  ...
  <tr>
    ...
    <table width="650" border="0" cellspacing="0" cellpadding="20" margin="0" padding="0" bgcolor="#FFFFFF" height="100%" align="center">
  		<tr>
            ...
            <br />
            L'équipe de <%=ERPStoreApplication.WebSiteSettings.SiteName%> vous confirme la prise en compte de votre commande et vous remercie de votre confiance.
            <br />
            <br />
            <font size="2">
            ...
            <hr noshade color="#dddddd" height="1" />
            <h3>Ce message vous est destiné :</h3>
            <p>
            <font size="2">
            ...
            <hr noshade color="#dddddd" height="1" />
            <h3>Votre référence de commande :</h3>
            <p>
            <font size="2">
            ...
            <hr noshade color="#dddddd" height="1" />
            <h3>Détail de la commande numéro : <strong><%=Model.Code%></strong></h3>
